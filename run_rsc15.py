...
PATH_TO_TRAIN = '/content/DynamicRec/nowplaying_grurec_train_data.csv'
PATH_TO_TEST = '/content/DynamicRec/nowplaying_grurec_test_data.csv'
...
if __name__ == '__main__':
    ...
    if os.path.exists('nowplaying_saved_model.pkl'):
        print('loading')
